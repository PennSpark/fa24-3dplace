...
import { FaChevronDown, FaChevronUp, FaCube, FaSync, FaArrowsAlt, FaSearchPlus } from 'react-icons/fa';
...
export function QuickGuide() {
  ...
  return (
    <div className="quick-guide ui-element">
      <button 
        className={`quick-guide-button ${isOpen ? 'quick-guide-button-open' : 'quick-guide-button-closed'}`} 
        onClick={toggleDropdown}
      >
        <span className="quick-guide-text">Quick Guide</span>
        {isOpen ? <FaChevronUp className="quick-guide-icon" /> : <FaChevronDown className="quick-guide-icon" />}
      </button>
      <div className={`quick-guide-dropdown ${isOpen ? 'show' : ''}`}>
        ...
        <div className="quick-guide-item">
          ...
          <span className="quick-guide-item-description">
            move mode <FaArrowsAlt className="quick-guide-item-icon" /> + left click
          </span>
        </div>
        <div className="quick-guide-item">
